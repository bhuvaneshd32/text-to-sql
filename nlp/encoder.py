...
# RIGHT — works whether you run from root or from inside nlp/
try:
...
class SchemaAwareEncoder(nn.Module):
    ...
    def forward(
        ...
        return Q_enc, S_schema, all_hidden 
...
if __name__ == "__main__":
    ...
    print(f"✓ Q_enc shape:    {Q_enc.shape}")
    print(f"✓ S_schema shape: {S_schema.shape}")
